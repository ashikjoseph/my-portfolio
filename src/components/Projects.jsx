...
function Projects() {
  return (
    <Container fluid className="project-section" style={{marginTop:"100px"}}>
    <Container>
      <h1 className="project-heading">
        My Recent <strong className="purple">Works </strong>
      </h1>
      <p style={{ color: "dark", marginTop:"50px", fontSize:"30px" }}>
        Here are a few projects which I have recently worked.
      </p>
      <Row style={{ justifyContent: "center", paddingBottom: "10px", marginTop:"50px" }}>
